...
(function (global) {
  ...
  var CATS = [
    ...
    { nome:'Apostas', padrao:true, semReducao:true, termos:{'cassino online':1,'aposta esportiva':1,'jogo do bicho':1,'aposta':.5,'cassino':.5,'tigrinho':1,'jogo do tigrinho':1,'bet365':1,'betano':1,'sportingbet':1,'blaze aposta':1,'roleta':.5,'roleta cassino':1,'apostar dinheiro':1,'apostas online':1,'site de apostas':1,'blaze':.5,'aviator':.5,'jogo aviator':1,'fortune tiger':1,'caca-niquel':1,'caca niquel':1,'jogo de azar':1,'poker valendo':1,'poker a dinheiro':1,'jogar no bicho':1,'raspadinha valendo':1,'raspadinha online':1,'raspadinha premiada':1,'online casino':1,'sports betting':1,'online gambling':1,'slot machine':1,'gambling':.5,'stake bet':1,'stake casino':1,'1xbet':1,'pixbet':1,'esportes da sorte':1,'superbet':1,'betfair':1,'kto bet':1,'kto apostas':1,'sportsbet':1,'blaze apostas':1}},
