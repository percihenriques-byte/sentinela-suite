...
(function (global) {
  ...
  var CATS = [
    ...
    { nome:'Autolesão e suicídio', padrao:true, semReducao:true, termos:{'suicidio':1,'como se matar':1,'me matar':1,'quero morrer':1,'vontade de morrer':1,'automutilacao':1,'me cortar':1,'cortar os pulsos':1,'tirar a propria vida':1,'tirar minha vida':1,'anorexia dicas':1,'pro ana':1,'me enforcar':1,'como se enforcar':1}},
    { nome:'Armas', padrao:true, semReducao:true, termos:{'como fazer bomba':1,'fazer uma bomba':1,'bomba caseira':1,'fabricar bomba':1,'fazer explosivo':1,'explosivo caseiro':1,'fabricar arma':1,'arma caseira':1,'explosivo':.5,'arma de fogo':.5,'comprar arma de fogo':1,'comprar fuzil':1,'arma no mercado negro':1,'comprar arma ilegal':1,'vender arma ilegal':1,'arma ilegal':.5,'pistola':.35,'rifle':.35,'fuzil':.35,'municao':.35}},
    { nome:'Drogas', padrao:true, semReducao:false, termos:{'como usar drogas':1,'comprar maconha':1,'usar cocaina':1,'cheirar cocaina':1,'comprar cocaina':1,'comprar droga':1,'cheirar cola':1,'cocaina':.5,'crack':.5,'maconha':.5,'lsd':.5,'ecstasy':.5,'droga':.35,'entorpecente':.5,'lanca perfume':1,'cheirar lolo':1,'cheirinho da lolo':1,'fumar baseado':1,'baseado de maconha':1,'comprar skunk':1,'skunk droga':1}},
    { nome:'Apostas', padrao:true, semReducao:true, termos:{'cassino online':1,'aposta esportiva':1,'jogo do bicho':1,'aposta':.5,'cassino':.5,'tigrinho':1,'jogo do tigrinho':1,'bet365':1,'betano':1,'sportingbet':1,'blaze aposta':1,'roleta':.5,'roleta cassino':1,'apostar dinheiro':1,'apostas online':1,'site de apostas':1,'blaze':.5,'aviator':.5,'jogo aviator':1,'fortune tiger':1,'caca-niquel':1,'caca niquel':1,'jogo de azar':1,'poker valendo':1,'poker a dinheiro':1,'jogar no bicho':1,'raspadinha valendo':1,'raspadinha online':1,'raspadinha premiada':1}},
