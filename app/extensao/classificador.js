...
(function (global) {
  ...
  var CATS = [
    ...
    { nome:'Armas', padrao:true, semReducao:true, termos:{'como fazer bomba':1,'fazer uma bomba':1,'bomba caseira':1,'fabricar bomba':1,'fazer explosivo':1,'explosivo caseiro':1,'fabricar arma':1,'arma caseira':1,'explosivo':.5,'pistola':.35,'rifle':.35,'municao':.35}},
    { nome:'Drogas', padrao:true, semReducao:false, termos:{'como usar drogas':1,'comprar maconha':1,'usar cocaina':1,'cheirar cocaina':1,'comprar cocaina':1,'comprar droga':1,'cocaina':.5,'crack':.5,'maconha':.5,'lsd':.5,'ecstasy':.5,'droga':.35,'entorpecente':.5}},
    { nome:'Apostas', padrao:true, semReducao:true, termos:{'cassino online':1,'aposta esportiva':1,'jogo do bicho':1,'aposta':.5,'cassino':.5,'tigrinho':1,'jogo do tigrinho':1,'bet365':1,'betano':1,'sportingbet':1,'blaze aposta':1,'roleta':.5,'roleta cassino':1,'apostar dinheiro':1,'apostas online':1,'site de apostas':1}},
