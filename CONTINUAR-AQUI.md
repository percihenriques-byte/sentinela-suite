...
- `app/Testes/Executar-Testes.ps1` (135 testes) · `Medir-Precisao.ps1` (corpus rotulado).
...
- Texto: **corpus 326 casos / 100%** (0 falso-pos/neg), **suíte 135/135**.
...
4. Sempre: manter Medir-Precisao 100% e suíte 135/135; PS+JS+demo sincronizados; commit+push
